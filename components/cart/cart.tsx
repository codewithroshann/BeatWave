            ...
            <div className="flex flex-col md:flex-row gap-5 mt-5">
                <div className='flex flex-col gap-5 flex-1'>
                    <div className='flex flex-col p-3 border rounded-md'>
                        <div className="flex justify-between aligns-center mb-3 ">
                            <h3 className='text-xl ml-2 font-semibold'>AkashBeats</h3>
                        ...
                        <div className='flex p-3 flex-wrap border rounded-md'>
                            ...
                            <div className="beat-info ml-4">
                                <div className="grid grid-cols-2 gap-2 items-center">
                                    <b className='text-primary'>Beat Producer : </b> <span className='text-sm ml-2'>AakashBeats</span>
                                </div>
                                <div className="grid grid-cols-2 gap-2 items-center">
                                    <b className='text-primary'>Audio File: </b> <span className='text-sm ml-2'>MP3</span>
                                </div>
                                <div className="grid grid-cols-2 gap-2 items-center">
                                    <b className='text-primary'>Lisence Type : </b> <span className='text-sm ml-2'>Free For Profit</span>
                                </div>
                                <div className="grid grid-cols-2 gap-2 items-center">
                                    <b className='text-primary'>Price : </b> <span className='text-sm ml-2 flex items-center'><FaRupeeSign className='text-xs' />599.00</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='w-full md:max-w-[450px]  border rounded-md p-3 flex-1 h-fit'>
                    ...
                    <div className="grid grid-cols-2 ">
                        <b className=''>Sub-Total :</b><span className='flex items-center'> <FaRupeeSign className='text-xs' />599.00</span>
                    </div>
                    <div className="grid grid-cols-2 ">
                    ...
                    <button className='bg-white hover:bg-white/80 duration-100  text-black p-2 mt-3 rounded-sm w-full'>Pay<span className='font-bold ml-2'>599.00</span></button>
