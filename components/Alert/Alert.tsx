...
const Alert = () => {
  ...
  return (
    <div className={`space-y-3 ${alert.visible ? "block" : "hidden"} fixed right-0 bottom-[90px] z-50 alert `}>
      ...
      <div className={` ${alert.type == "info" ? "block" : "hidden"} max-w-xs bg-white border border-primary rounded-xl alert shadow-lg dark:bg-neutral-800 dark:border-neutral-700" role="alert" tabIndex={-1} aria-labelledby="hs-toast-normal-example-label`}>
     ...
     {/* <Alert variant="error">This is a error message.</Alert> */}
  <div className={`${alert.type == "error" ? "block" : "hidden"}  max-w-xs bg-white border border-primary rounded-xl shadow-lg dark:bg-neutral-800 dark:border-neutral-700" role="alert" tabindex="-1" aria-labelledby="hs-toast-error-example-label`}>
    <div className="flex p-4">
      <div className="shrink-0">
  ...
  <div className={`${alert.type == "warning" ? "block" : "hidden"} max-w-xs bg-white border border-primary rounded-xl shadow-lg dark:bg-neutral-800 dark:border-neutral-700" role="alert" tabindex="-1" aria-labelledby="hs-toast-warning-example-label`}>
    <div className="flex p-4">
      <div className="shrink-0">
