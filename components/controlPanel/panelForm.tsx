...
const panelForm = () => {
  return (
    ...
    dark:file:bg-primary dark:file:text-white" required />
        ...
        <button type="submit" className="text-white bg-blue-700 hover:bg-primary/70 duration-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md w-full sm:w-auto px-8 py-2.5 text-center dark:bg-primary dark:hover:bg-primary/70 mt-8">Submit</button>
      </form>
