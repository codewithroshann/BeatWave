            ...
            <div className="container md:p-12">
                ...
                <div className="grid  sm:grid-cols-2  grid-cols-1 mt-5  gap-10 sm:gap-6" >
                    ...
                    <div className='flex order-2 sm:order-none flex-col  items-start cols-start-2'>
                        ...
                        <form action={"/auth/user/signup"} method='post' className="max-w-xl mt-6 w-full">
                            ...
                            <button type="submit" className="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm w-full duration-100  px-5 py-2.5 text-center dark:bg-primary dark:hover:bg-primary/70 dark:focus:ring-blue-800">Signup For Free</button>
                        </form>
                    ...
                    <div className='order-1 sm:order-none'>
                        ...
                        <a href="/auth/user/login" className='btn px-3 py-2 text-sm font-medium text-center text-white bg-primary mt-6 rounded-sm ' >Login</a>
                        <div className=" ">
