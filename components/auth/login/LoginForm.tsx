    ...
    <>
      <div className="flex sm:order-none flex-col items-start cols-start-2">
        ...
        <p className="text-zinc-400 text-sm">
          Join our platform and start exploring...
        </p>
        <form className="max-w-xl mt-6 w-full" onSubmit={handleLogin}>
          ...
          <button
            ...
            className={`${
              loading == true ? "cursor-not-allowed" : ""
            } text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm w-full duration-100 px-5 py-2.5 text-center dark:bg-primary dark:hover:bg-primary/70 dark:focus:ring-blue-800`}
          >
            Login
          </button>
        </form>
        <p className="text-sm mt-6">
          ...
          <Link href="/auth/user/signup" className="text-primary ml-2">
            Signup
          </Link>
        </p>
